...
const TemplateHelper = () => {
    ...
    return (
        <div className="template-helper mx-2 sm:mx-32">
            <p className="mt-2 mb-3 text-center text-2xl font-semibold leading-relaxed text-gray-900  dark:text-slate-800">Template Helper</p>
            ...
            {jsxContent && <div className="relative flex flex-col mb-4">
                <p className="text-lg font-semibold text-gray-900  dark:text-slate-800">JSX</p>
                <div className="relative">
            ...
            {fnContent && <div className="relative flex flex-col mb-4">
                <p className="text-lg font-semibold text-gray-900 dark:text-slate-800 ">Get Value Function {path}</p>
                <div className="relative">
            ...
            {indexContent && <div className="relative flex flex-col mb-4">
                <p className="text-lg font-semibold text-gray-900 dark:text-slate-800 ">Index JS {path}</p>
                <div className="relative">
