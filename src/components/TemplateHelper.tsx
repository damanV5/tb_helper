...
const TemplateHelper = () => {
    ...
    return (
        <div className="template-helper mx-2 sm:mx-32">
            <p className="mt-2 mb-3 text-center text-2xl font-semibold leading-relaxed text-gray-900 dark:text-white">Template Helper</p>
            ...
            <div className="key-wrapper m-auto mb-6">
                ...
                <div className="mb-4">
                    <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Keys (CSV)</label>
            ...
            {constructorContent && <div className="relative flex flex-col mb-4">
                <p className="text-lg font-semibold text-gray-900 dark:text-white">Constructor</p>
            ...
            {jsxContent && <div className="relative flex flex-col mb-4">
                <p className="text-lg font-semibold text-gray-900 dark:text-white">JSX</p>
                <div className="relative">
            ...
            {fnContent && <div className="relative flex flex-col mb-4">
                <p className="text-lg font-semibold text-gray-900 dark:text-white">Get Value Function {path}</p>
                <div className="relative">
            ...
            {indexContent && <div className="relative flex flex-col mb-4">
                <p className="text-lg font-semibold text-gray-900 dark:text-white">Index JS {path}</p>
                <div className="relative">
